...
def analyze_content(uploaded_file):
    # هنا يتم ربط الـ API الخاص بـ Computer Vision مستقبلاً
    # سنقوم بمحاكاة التحليل بناءً على اسم الملف المرفوع كمثال ذكي
...
with tab2:
    ...
    # شبكة العرض (Masonry Grid Simulation)
    col1, col2 = st.columns(2)
    with col1:
